...
public class MergingTables {
    ...
    class Table {
        ...
        int compareTo(Table another) {
        	if(another.rank > this.rank)
        		return -1;
        	else if(another.rank == this.rank)
        		return 0;
        	else return 1; 
        }
    }
...
//        	parent[j_id] ← i_id
        int num = 0;
        if(realDestination.compareTo(realSource) == 1) {
        	realSource.parent =  realDestination;
        	realDestination.numberOfRows += realSource.numberOfRows;
        	num = realDestination.numberOfRows;
        } else {
//        	parent[i_id] ← j_id
//        	if rank[i_id] = rank[j_id]:
//        	rank[j_id] ← rank[j_id] + 1
        	...
        	num = realSource.numberOfRows;
        }
        maximumNumberOfRows = maximumNumberOfRows > num ? maximumNumberOfRows : num;
    }
